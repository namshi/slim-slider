...
var SlimSlider = function SlimSlider(options) {
  _classCallCheck(this, SlimSlider);

  var selectors = [].slice.apply(options.selector);

  return selectors.map(function (selector) {
    var newOptions = Object.assign({}, options);
    newOptions.selector = selector;
    return new Slider(newOptions);
  });
};
  ...
  _createClass(Slider, [{
    ...
    value: function initDom() {
      ...
      if (!this.slider || !this.sliderWrapper) {
        ...
        this.slides.forEach(function (slide) {
          _this2.slider.appendChild(slide);
        });
    ...
    value: function createThumbs() {
      ...
      var _loop = function _loop(k) {
        ...
        _this3.events.addEvent(thumb, 'click', function (e) {
          e.preventDefault();
          _this3.slideTo(k);
        });
      };
    ...
    value: function slideTo(n) {
      ...
      this.timeout = setTimeout(function (_) {
        ...
        (0, _utils.dispatchEvent)(_this6.parent, 'after.slim.slide', { current: _this6.current });
      }, this.timing);
